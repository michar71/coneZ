...
static const ApiFunc api_funcs[] = {
    ...
    {"file_open",       IMP_FILE_OPEN,       CT_INT,   2, {CT_INT,CT_INT}},
    ...
    {"file_seek",       IMP_FILE_SEEK,       CT_INT,   3, {CT_INT,CT_INT,CT_INT}},
    {"file_tell",       IMP_FILE_TELL,       CT_INT,   1, {CT_INT}},
    {"file_eof",        IMP_FILE_EOF,        CT_INT,   1, {CT_INT}},
    {"file_truncate",   IMP_FILE_TRUNCATE,   CT_INT,   2, {CT_INT,CT_INT}},
    {"file_flush",      IMP_FILE_FLUSH,      CT_INT,   1, {CT_INT}},
    {"file_readln",     IMP_FILE_READLN,     CT_INT,   3, {CT_INT,CT_INT,CT_INT}},
    {"file_readln_str", IMP_FILE_READLN_STR, CT_INT,   1, {CT_INT}},
    {"file_writeln",    IMP_FILE_WRITELN,    CT_INT,   2, {CT_INT,CT_INT}},
    {"file_stat",       IMP_FILE_STAT,       CT_INT,   2, {CT_INT,CT_INT}},
    {"file_delete",     IMP_FILE_DELETE,     CT_INT,   1, {CT_INT}},
    {"file_rename",     IMP_FILE_RENAME,     CT_INT,   2, {CT_INT,CT_INT}},
    {"file_mkdir",      IMP_FILE_MKDIR,      CT_INT,   1, {CT_INT}},
    {"file_rmdir",      IMP_FILE_RMDIR,      CT_INT,   1, {CT_INT}},
    {"dir_open",        IMP_DIR_OPEN,        CT_INT,   1, {CT_INT}},
    {"dir_read",        IMP_DIR_READ,        CT_INT,   2, {CT_INT,CT_INT}},
    {"dir_close",       IMP_DIR_CLOSE,       CT_VOID,  1, {CT_INT}},
