...
const ImportDef imp_defs[IMP_COUNT] = {
    ...
    [IMP_FILE_OPEN]      = {"file_open",            2,{_I,_I},         1,{_I}},
    ...
    [IMP_FILE_SEEK]      = {"file_seek",            3,{_I,_I,_I},      1,{_I}},
    [IMP_FILE_TELL]      = {"file_tell",            1,{_I},            1,{_I}},
    [IMP_FILE_EOF]       = {"file_eof",             1,{_I},            1,{_I}},
    [IMP_FILE_TRUNCATE]  = {"file_truncate",        2,{_I,_I},         1,{_I}},
    [IMP_FILE_FLUSH]     = {"file_flush",           1,{_I},            1,{_I}},
    [IMP_FILE_READLN]    = {"file_readln",          3,{_I,_I,_I},      1,{_I}},
    [IMP_FILE_READLN_STR]= {"file_readln_str",      1,{_I},            1,{_I}},
    [IMP_FILE_WRITELN]   = {"file_writeln",         2,{_I,_I},         1,{_I}},
    [IMP_FILE_STAT]      = {"file_stat",            2,{_I,_I},         1,{_I}},
    [IMP_FILE_DELETE]    = {"file_delete",          1,{_I},            1,{_I}},
    [IMP_FILE_RENAME]    = {"file_rename",          2,{_I,_I},         1,{_I}},
    [IMP_FILE_MKDIR]     = {"file_mkdir",           1,{_I},            1,{_I}},
    [IMP_FILE_RMDIR]     = {"file_rmdir",           1,{_I},            1,{_I}},
    [IMP_DIR_OPEN]       = {"dir_open",             1,{_I},            1,{_I}},
    [IMP_DIR_READ]       = {"dir_read",             2,{_I,_I},         1,{_I}},
    [IMP_DIR_CLOSE]      = {"dir_close",            1,{_I},            0,{}},
    ...
    [IMP_INFLATE_FILE]   = {"inflate_file",          2,{_I,_I},         1,{_I}},
    [IMP_INFLATE_FILE_TO_MEM]={"inflate_file_to_mem",3,{_I,_I,_I},      1,{_I}},
    [IMP_INFLATE_MEM]    = {"inflate_mem",           4,{_I,_I,_I,_I},   1,{_I}},
    [IMP_DEFLATE_FILE]   = {"deflate_file",          2,{_I,_I},         1,{_I}},
    [IMP_DEFLATE_MEM_TO_FILE]={"deflate_mem_to_file",3,{_I,_I,_I},      1,{_I}},
