...
See `documentation/lora-protocol.txt` for the full wire-format specification (ConeZ header, beacon/file-block packet layouts, RF-parameter and file-type encodings, page/block chunking, manifest format, regulatory context, master radio-config notes §16, and known discrepancies).
