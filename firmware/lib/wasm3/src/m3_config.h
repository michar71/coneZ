...
# ifndef d_m3UsePsramMemory
#   define d_m3UsePsramMemory            0       // route WASM linear memory through SPI PSRAM
# endif

# ifndef d_m3PsramDramWindow
#   define d_m3PsramDramWindow           4096    // bytes of DRAM fast-path at start of linear memory
# endif
